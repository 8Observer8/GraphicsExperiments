...
let MyGrass = new Quad(SimpleVertexShader, SimpleFragmentShader, "../Assets/Textures/grass.png", null, MyQuadMesh);

let MyAnotherGrass = new Quad(SimpleVertexShader, SimpleFragmentShader, "../Assets/Textures/grass.png", null, MyQuadMesh);

let AndAnotherGrass = new Quad(SimpleVertexShader, SimpleFragmentShader, "../Assets/Textures/grass.png", null, MyQuadMesh);
...
function Init()
{
    ...
    MyAnotherGrass.Transform = <any>{};

    MyAnotherGrass.Transform.Position = Vec3.FromValues(2.0, 0.9, -2.0);

    MyAnotherGrass.Transform.Rotation = Quat.Create();

    MyAnotherGrass.Transform.Scaling = Vec3.FromValues(1, 1, 1);

    AndAnotherGrass.Transform = <any>{};

    AndAnotherGrass.Transform.Position = Vec3.FromValues(-3.0, 0.9, -2.5);

    AndAnotherGrass.Transform.Rotation = Quat.Create();

    AndAnotherGrass.Transform.Scaling = Vec3.FromValues(1, 1, 1);
...
function Render(): void 
{
    ...
    MyAnotherGrass.Render();

    AndAnotherGrass.Render();
